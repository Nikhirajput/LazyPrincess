...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1842014823').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nr8261819271:8261819271@cluster0.zc1lzfb.mongodb.net/?retryWrites=true&w=majority")
...
OPENAI_API = environ.get("OPENAI_API","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")
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001930805112")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'onepagelinks.in') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'e8ee3046dc95ee2ba1cde200d11e27c9227991dd')
